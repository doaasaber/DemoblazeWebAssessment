...
public class BrowserActions {
    ...
    public static String waitAndGetAlertText(WebDriver driver){
    ...
    public static String waitAndGetCellText(By element,By cell, WebDriver driver) throws Exception {
        BrowserActions.waitUntilWebElementIsPresent(element, driver);

        String Text;
        try {
            WebElement cellData=driver.findElement(element).findElement(cell);
            Text=cellData.getText();
        } catch (Exception e) {
            e.printStackTrace();
            System.out.println(e.getMessage());
            throw new Exception("Can not get text of webElement: " + element.toString(),e);
